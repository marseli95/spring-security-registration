...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final List<Privilege> managerPrivileges = new ArrayList<>(Arrays.asList(managePrivilege));
        ...
        createUserIfNotFound("test2@test.com", "Test", "Test", "test", new ArrayList<>(Arrays.asList(managerRole)));
